...
func _read_current_game_state():
	...
	gamestate_seed = RunManager.run_seed
...
func _get_player_state_dict(player : Player) -> Dictionary:
	var player_state = {}
...
func _write_out_gamestate(file_path : String) -> bool:
	...
	var player_state_dict = _get_player_state_dict(gamestate_player)
...
func _load_game_from_save():
	...
	gamestate_seed = save_file_dict["seed"]
