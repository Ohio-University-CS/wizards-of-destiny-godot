...
@onready var level_select_button : Button = $"Buttons/Level 4"
...
func _on_forward_button_pressed():
	get_tree().change_scene_to_file("res://scenes/Level Select/level_5.tscn")

func _on_back_button_pressed():
	get_tree().change_scene_to_file("res://scenes/Level Select/level_3.tscn")
